...
var
Form1: TForm1;
cx,cy,cx2,cy2,cx3,cy3,dt,fx,fy,fx_old,g,r_1,r_2,r_3,vx_old,Rkv_2_1,Rkv_3_2,Rkv_3_1,Rkv_4_1,Rkv_4_2,Rkv_4_3,dF:real;
x,y,i:integer;
...
begin
//dF:=10000;
Rkv_2_1:=sqr(star2.x-star1.x)+sqr(star2.y-star1.y);//квадраты расстояния
...
star1.fx:=((star2.x-star1.x)/(2*sqrt(Rkv_2_1)*Rkv_2_1))+((star3.x-star1.x)/(2*sqrt(Rkv_3_1)*Rkv_3_1))+((star4.x-star1.x)/(2*sqrt(Rkv_4_1)*Rkv_4_1));// считаем G=m1=m2=1`
...
star2.fx:=((star1.x-star2.x)/(2*sqrt(Rkv_2_1)*Rkv_2_1))+((star3.x-star2.x)/(2*sqrt(Rkv_3_1)*Rkv_3_1))+((star4.x-star2.x)/(2*sqrt(Rkv_4_2)*Rkv_4_2));// считаем G=m1=m2=1`
...
star3.fx:=((star1.x-star3.x)/(2*sqrt(Rkv_3_1)*Rkv_3_1))+((star2.x-star3.x)/(2*sqrt(Rkv_3_2)*Rkv_3_2))+((star4.x-star3.x)/(2*sqrt(Rkv_4_3)*Rkv_4_3));// считаем G=m1=m2=1`
...
star4.fx:=((star1.x-star4.x)/(2*sqrt(Rkv_4_1)*Rkv_4_1))+((star3.x-star4.x)/(2*sqrt(Rkv_4_3)*Rkv_4_3))+((star2.x-star4.x)/(2*sqrt(Rkv_4_2)*Rkv_4_2));// считаем G=m1=m2=1`
...
rasstoyaniya_and_grav_sila;// рассчитываем расстояния и силы взаимодействия между объектами
electr_sila;
...
form1.Image2.Canvas.Pixels[i,(form1.Image2.Height div 2)-trunc(star1.fx/cx2)]:=clred;
form1.Image3.Canvas.Pixels[i,(form1.Image3.Height div 2)-trunc(star1.vx/cx3)]:=clred;
...
x:=trunc(star1.x/cx);
y:=trunc(star1.y/cy);
Ellipse(x+(form1.image1.Width div 2)+4,(form1.image1.Height div 2)-y+4,x+(form1.image1.Width div 2)-4,(form1.image1.Height div 2)-y-4);
